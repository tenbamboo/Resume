<template>
  <div class="indexContainer commonContainer">
    ...
    <div class="powerBy">
       Powered By <span class="link">GitHub : @tenbamboo/Resume</span>
    </div>
  </div>
</template>
...
.indexContainer {
  ...
  .skillList .content view {
    padding: 5px;
  }

  .skillList .content view:first-child,
  .starList .content view:first-child {
    padding-top: 0;
  }

  .starList .content view {
    padding: 5px;
    display: flex;
  }

  .starList .content view span {
    margin-right: 10px;
    width: 100px;
  }

  .starList .content view image {
    width: 20px;
    height: 20px;
    vertical-align: middle;
    margin-right: 5px;
